...
define( 'COURTNEYR_CHILD_VERSION', '0.7.66' );
...
require_once __DIR__ . '/inc/a11y-output.php';
require_once __DIR__ . '/inc/post-kinds.php';
require_once __DIR__ . '/inc/mood-motifs.php';
require_once __DIR__ . '/inc/mood-pin.php';
...
require_once __DIR__ . '/inc/aside-scrap.php';
require_once __DIR__ . '/inc/sticky-note.php';
