...
SVG,
		...
		'openprofile' => array(
			...
			'svg'    => <<<'SVG'
<svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M9.4,7.5 L4.9,12 L9.4,16.5 L8,18 L2,12 L8,6 L9.4,7.5 Z M14.6,7.5 L19.1,12 L14.6,16.5 L16,18 L22,12 L16,6 L14.6,7.5 Z M12,9 C13.1,9 14,9.9 14,11 C14,12.1 13.1,13 12,13 C10.9,13 10,12.1 10,11 C10,9.9 10.9,9 12,9 Z"/></svg>
SVG,
		),
	);
}
